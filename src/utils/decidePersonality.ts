...
const decidePersonality = (selections: Selection[]): PEOPLE => {
    ...
    const personality = _.reduce(selections, (acc, cur) => {
        switch(cur.type) {
    ...
    if(personality.energy > 0){ //E
        if(personality.focus > 0){ //EN
            if(personality.judgement > 0){ //ENF
                if(personality.decision > 0){ //* ENFJ
                    result = PEOPLE.JONATHAN;
                }else { //* ENFP
                    result = PEOPLE.PETER
                }
            }else { //ENT
                if(personality.decision > 0){ //* ENTJ
            ...
            if(personality.judgement > 0){ //ESF
        ...
        if(personality.focus > 0){ //IN
            if(personality.judgement > 0){ //INF
                if(personality.decision > 0){ //* INFJ
            ...
            if(personality.judgement > 0){ //ISF
                if(personality.decision > 0){ //* ISFJ
                    result = PEOPLE.LUKE;
                }else { //* ISFP
                    result = PEOPLE.JOB
                }
